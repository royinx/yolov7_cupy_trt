...
from myCalibrator import EntropyCalibrator
...
if __name__ == "__main__":
    ...
    if args.mode.lower() == 'int8':
        ...
        # You can reference implementation of EntropyCalibrator.
        calib = EntropyCalibrator(args)
    else:
        calib = None
    ONNX2TRT(args, calib=calib)

# python3 main.py --batch_size 10 --height 640 --width 640 --cache_file ./cal.cache --mode int8 --onnx_file_path myfiles/ped_yolov7_8.onnx --engine_file_path ./myfiles/ped_yolov7_8_int8.trt